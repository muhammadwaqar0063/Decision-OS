    ...
    overlay.innerHTML = `
      <div style="background:#fff;border-radius:16px;padding:32px;width:400px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.15)">
        ...
        <div style="display:flex;gap:8px;justify-content:flex-end">
          ...
          <button onclick="DSLAuth.submitChangePassword()" style="padding:8px 20px;border-radius:8px;font-size:11px;font-weight:600;border:none;background:#003399;color:#fff;cursor:pointer;font-family:inherit">Update Password</button>
        </div>
      </div>`;
